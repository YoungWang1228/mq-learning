package com.youngwang.redismq.mson.stream.service.b;
 ...
 */
@Configuration
public class MsonStreamReceiver implements ApplicationListener<ApplicationStartedEvent> {

    public static final String MSON_STREAM_MQ_KEY = "MSON_STREAM_MQ_KEY";
...
//                .objectMapper(new Jackson2HashMapper(true))
    ...
    public StreamListener<String, MapRecord<String, String, String>> streamListener(
        ...
        String streamKey = MSON_STREAM_MQ_KEY;
