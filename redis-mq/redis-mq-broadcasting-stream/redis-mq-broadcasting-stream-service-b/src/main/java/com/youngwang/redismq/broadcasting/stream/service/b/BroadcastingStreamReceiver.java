package com.youngwang.redismq.broadcasting.stream.service.b;
 ...
 */
@Configuration
public class BroadcastingStreamReceiver implements ApplicationListener<ApplicationStartedEvent> {

    public static final String BROADCASTING_STREAM_MQ_KEY = "BROADCASTING_STREAM_MQ_KEY";
...
//                .objectMapper(new Jackson2HashMapper(true))
    ...
    public StreamListener<String, MapRecord<String, String, String>> streamListener(
        ...
        String streamKey = BROADCASTING_STREAM_MQ_KEY;
