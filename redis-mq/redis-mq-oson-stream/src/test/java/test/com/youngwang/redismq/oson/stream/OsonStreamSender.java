package test.com.youngwang.redismq.oson.stream;

import com.youngwang.redismq.oson.stream.OsonStreamReceiver;
...
public class OsonStreamSender {
    ...
    public void sendMessage() {
        BoundStreamOperations<String, String, String> operations = redisTemplate.boundStreamOps(OsonStreamReceiver.OSON_STREAM_MQ_KEY);
        for (int i = 0; i < 10; i++) {
